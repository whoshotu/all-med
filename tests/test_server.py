...
def test_trigger_event_success():
    payload = {
        ...
        "patient_phone": "+12125550101",   # NANP 555-01xx reserved fictional range
...
def test_trigger_event_missing_phone():
    """patient_phone is required — omitting it must return 422 Unprocessable Entity."""
    payload = {
        "event_type": "missed_appointment",
        "patient_id": "PAT-TEST-2",
        "source_system": "opendental",
    }
    response = client.post("/api/events/trigger", json=payload)
